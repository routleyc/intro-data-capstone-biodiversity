...
ax.set_xticklabels(protection_counts.conservation_status.unique())
...
#minimum_detectable_effect = 100 * (old - new) / old
minimum_detectable_effect = 100 * (.15 - .1) / .15
...
approximately 2 weeks at Bryce National Park
approximately 1 weeks at Yellowstone National Park
